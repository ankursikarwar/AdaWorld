...
ax.set_title("UMAP of LAM Latent Actions — Train vs Test (ssv2_our+mira, 10k samples)")
...
for ax, name, emb, z_mu in [
    ...
    ax.set_xlabel("UMAP 1")
    ax.set_ylabel("UMAP 2")
fig.suptitle("UMAP of LAM Latent Actions — colored by L2 norm (ssv2_our+mira)", fontsize=14)
...
ax.set_title("UMAP of LAM Latent Actions — by Action Category (ssv2_our+mira)")
ax.set_xlabel("UMAP 1")
ax.set_ylabel("UMAP 2")
